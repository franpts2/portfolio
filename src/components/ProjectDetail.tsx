	...
	return (
		<div className="project-detail relative min-h-screen flex flex-col items-center gap-10">
			<div className="w-4xl mt-10 flex flex-col gap-4">
				{/* back button */}
				<div onClick={() => navigate('/projects')} className="flex flex-row gap-2 cursor-pointer w-fit hover:text-secondary group">
					<Icon icon={icons.arrowLeft.fill} height={24} className="transition-transform duration-300 ease-in-out group-hover:-translate-x-1"/>
